...
<body>
		...
		<nav class="navbar navbar-expand-lg bg-body-tertiary">
			<div class="container-fluid">
				<ul class="navbar-nav justify-content-end">
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="#"><i class="ti ti-arrow-left"></i>&nbsp;Back to Home</a>
					</li>
				</ul>
			</div>
		</nav>
	...
	<main>
		<div class="d-flex">
			<?php require APPPATH . 'views/components/dashboard/_sidebar_settings.php'; ?>
			<div class="w-100 ">
	...
	<footer>
		<?php require APPPATH . 'views/components/dashboard/_footer.php'; ?>
	</footer>
