							...
							<div class="card">
								...
								<div class="card-body">
									<nav class="nav tab-steps">
										<a class="nav-link tab-item-step" href="<?= base_url("app/" . $configs['app_id'] . "/company-onboarding/settings") ?>">Enter Company Details</a>
										<a class="nav-link tab-item-step done" href="<?= base_url("app/" . $configs['app_id'] . "/company-onboarding/payroll") ?>">Set Payroll Date</a>
										<a class="nav-link tab-item-step active" aria-current="page" href="<?= base_url("app/" . $configs['app_id'] . "/company-onboarding/salary") ?>">Set Salary Structure</a>
									</nav>
								</div>
							</div>
						</div>
